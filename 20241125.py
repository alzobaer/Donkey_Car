...
def wall_detection(frame, depth):
    ...
    elif avg_depth_top_left < DEPTH_THRESHOLD_FAR:
        capture_image(frame)
        _decide_how_long_adjust()
        print("d")
    elif avg_depth_bottom_left_hard < DEPTH_THRESHOLD_FAR:
        capture_image(frame)
        _decide_how_long_adjust()
        print("e")
    elif avg_depth_center_left_hard < DEPTH_THRESHOLD_FAR:
        capture_image(frame)
        _decide_how_long_adjust()
    # Check for obstacles to the right and adjust angle if needed
    elif avg_depth_top_right < DEPTH_THRESHOLD_FAR:
        capture_image(frame)
        _decide_how_long_adjust()
    elif avg_depth_bottom_right_hard < DEPTH_THRESHOLD_FAR:
        capture_image(frame)
        _decide_how_long_adjust()
    elif avg_depth_center_right < DEPTH_THRESHOLD_NEAR:
        capture_image(frame)
